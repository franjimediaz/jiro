  ...
  return (
    <div className={styles.contenedor}>
      <div className={styles.tarjeta}>
        <h3>Empresa</h3>
        <p><strong>Nombre:</strong> {branding.nombre}</p>
        <p><strong>CIF:</strong> {branding.cif}</p>
        <p><strong>Dirección:</strong> {branding.direccion}</p>
        <p><strong>Teléfono:</strong> {branding.telefono}</p>
